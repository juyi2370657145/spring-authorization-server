...
public class UserPasswordAuthenticationProvider implements AuthenticationProvider {
   ...
   * @return 认证信息
   */
  public Authentication getAuthenticatedUser(UserPasswordAuthenticationToken authenticationToken) {
    // 获取用户密码
    Map<String, Object> additionalParameters = authenticationToken.getAdditionalParameters();
    String username = (String) additionalParameters.get(SecurityConstants.OAUTH_PARAMETER_USERNAME);
    String password = (String) additionalParameters.get(SecurityConstants.OAUTH_PARAMETER_USERNAME_PASSWORD);
    // 使框架支持账号密码登录
